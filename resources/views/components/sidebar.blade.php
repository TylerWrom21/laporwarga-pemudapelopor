...
<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen bg-gray-50 dark:bg-gray-800 transform -translate-x-full transition-transform duration-300 ease-in-out sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium mt-20">
            ...
            <li>
                <a href="{{ route('petugas.dashboard') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                   <i class="fa-solid fa-user"></i>
                   <span class="flex-1 ms-3 whitespace-nowrap">{{ Auth::user()->nama }}</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('petugas.aspirasi') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-newspaper"></i>
                    <span class="flex-1 ms-3 whitespace-nowrap">Aspirasi</span>
                </a>
            </li>
            <li>
                <a href="{{ route('petugas.masyarakat') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-users"></i>
                    <span class="flex-1 ms-3 whitespace-nowrap">Masyarakat</span>
                </a>
            </li>
